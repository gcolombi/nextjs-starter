            ...
            <section className='u-spacing--responsive'>
                <div className='o-container'>
                    <div className='o-wysiwyg'>
                        <h1>Article</h1>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi, illum eius nobis asperiores maiores dolorem amet cupiditate quisquam soluta ad vel, laudantium qui recusandae inventore incidunt, dignissimos sequi quaerat? Iusto?</p>
                    </div>
                </div>
            </section>
            <section className='u-spacing--responsive'>
